...
def publish_status_strings():
    ...
    publishers.append(rospy.Publisher("/limo_status/vehicle_state", String, queue_size=1))
    publishers.append(rospy.Publisher("/limo_status/control_mode", String, queue_size=1))
    publishers.append(rospy.Publisher("/limo_status/battery_voltage", String, queue_size=1))
    publishers.append(rospy.Publisher("/limo_status/error_code", String, queue_size=1))
    publishers.append(rospy.Publisher("/limo_status/motion_mode", String, queue_size=1))
